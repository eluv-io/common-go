module github.com/qluvio/content-fabric/format
...
require (
	...
	github.com/qluvio/content-fabric/util v0.0.0-00010101000000-000000000000
...
replace github.com/qluvio/content-fabric/util => ../util/
