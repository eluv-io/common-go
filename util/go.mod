module github.com/qluvio/content-fabric/util
...
require (
	...
	github.com/qluvio/content-fabric/format v0.0.0-00010101000000-000000000000
...
replace github.com/qluvio/content-fabric/format => ../format/
