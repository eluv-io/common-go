...
func DecryptKeyFileJSON(keyfile string, password string) (*keystore.Key, error) {
	...
	return decryptKeyJSON(keyBytes, password)
}
...
/*
 * Decrypts an Ethereum encrypted keystore json
 * Return: private key
 */
func decryptKeyJSON(keyBytes []byte, password string) (*keystore.Key, error) {
